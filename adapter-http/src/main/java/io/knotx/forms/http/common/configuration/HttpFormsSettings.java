 ...
 */
package io.knotx.forms.http.common.configuration;
...
public class HttpFormsSettings {
   ...
   */
  public HttpFormsSettings(HttpFormsSettings other) {
   ...
   */
  public HttpFormsSettings setDomain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public HttpFormsSettings setAllowedRequestHeaders(Set<String> allowedRequestHeaders) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public HttpFormsSettings setQueryParams(JsonObject queryParams) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public HttpFormsSettings setAdditionalHeaders(JsonObject additionalHeaders) {
  ...
  @GenIgnore
  public HttpFormsSettings setAllowedRequestHeaderPatterns(List<Pattern> allowedRequestHeaderPatterns) {
