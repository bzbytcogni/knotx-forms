...
public class HttpFormsAdapterOptions {
   ...
   */
  public HttpFormsAdapterOptions(HttpFormsAdapterOptions other) {
   ...
   */
  public HttpFormsAdapterOptions setAddress(String address) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public HttpFormsAdapterOptions setClientOptions(WebClientOptions clientOptions) {
